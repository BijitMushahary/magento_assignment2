...
ALTER TABLE `{$installer->getTable('sales/quote_payment')}` ADD `payee_name` VARCHAR( 255 ) NOT NULL ;
...
ALTER TABLE `{$installer->getTable('sales/order_payment')}` ADD `payee_name` VARCHAR( 255 ) NOT NULL ;
